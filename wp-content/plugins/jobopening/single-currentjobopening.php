        ...
        <div class="detail_post">
         <div class="cstm_post_job">
           ...
           <div class="job_skill">
             ...
             <p class="cstm_skill"><?php echo get_post_meta(get_the_ID(), "skills_title_name", true);?></p>
             
           </div>

           <div class="job_qualification">
             <h4 class="cstm_h4_qualifi">Qualifications</h4>
             <p class="cstm_qualifi"><?php echo get_post_meta(get_the_ID(), "qualification_title_name", true);?></p>
